...
export default function AdministratorTimekeepingPage() {
      ...
      <div className="p-6 bg-white shadow-sm border-b border-gray-200">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 lg:gap-6">
          <div className="text-center lg:text-left">
            ...
            <p className="mt-1 sm:mt-2 text-sm sm:text-base text-gray-600">Administrator view - Manage attendance, time tracking, leaves, overtime, and schedules</p>
          </div>
