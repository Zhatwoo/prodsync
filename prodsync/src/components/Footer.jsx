        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center space-x-2 mb-6">
              ...
              <span className="text-xl font-bold">ProdSync</span>
            </div>
            <p className="text-slate-300 mb-6 leading-relaxed">
              Enterprise-grade productivity platform trusted by Fortune 500 companies worldwide. 
              Transform your organization's efficiency with our comprehensive suite of tools.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/press" className="text-slate-300 hover:text-white transition-colors">
                  Press
                </Link>
              </li>
              <li>
